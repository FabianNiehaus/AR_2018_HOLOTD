...
namespace TowerDefense.UI
{
	...
	public class PauseMenu : MonoBehaviour
	{
		...
		{
            //pauseMenuCanvas = GameObject.FindGameObjectWithTag("PauseMenuCanvas").GetComponent<Canvas>();
		...
		public void ClosePauseMenu()
		{
            ...
            //if(levelSelectConfirmButton.gameObject != null)
            //{
                levelSelectConfirmButton.gameObject.SetActive(false);
                levelSelectButton.interactable = true;
            //}
            //if (restartConfirmButton.gameObject != null)
            //{
